      ...
      <tr>
        ...
        <td>
          <input class="common-text required" name="category_name" size="50"
                 value="<?php echo set_value('category_name') ? set_value('category_name') : $category_name; ?>"
                 type="text">
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input class="common-text required" name="order_sort" size="10"
                 value="<?php echo set_value('order_sort') ? set_value('order_sort') : $order_sort; ?>" type="text">
        </td>
      </tr>
      <tr>
        <th></th>
